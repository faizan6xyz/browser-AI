...
def run_agent2(goal: str, start_url: str):
    ...
    print("=" * 60)
    if "reels" in start_url :
        starturl = start_url.replace("reels","p")
    # Navigate first to generate initial snapshot
    print("\n--- Initial Navigation ---")
    mcp.call_tool("browser_navigate", {"url": starturl})
    time.sleep(2)
...
if __name__ == "__main__":
    ...
    reelurl = input("Enter your post url : ")
    run_agent2(user,reelurl)
